...
setprop("enemies/e0","tgt");
setprop("enemies/e1","tgt");
setprop("enemies/e2","tgt");
setprop("enemies/e3","tgt");
setprop("enemies/e4","tgt"); 
setprop("enemies/e5","tgt");
setprop("enemies/e6","tgt");
setprop("enemies/e7","tgt");
setprop("enemies/e8","tgt");
setprop("enemies/e9","tgt");
setprop("enemies/e10","tgt");
setprop("enemies/e11","tgt");
setprop("enemies/e12","tgt");
setprop("enemies/e13","tgt");
setprop("enemies/e14","tgt");
setprop("enemies/e15","tgt");
...
faketimer = maketimer(0,fakethreat);
