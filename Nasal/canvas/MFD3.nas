...
# 
# Canvas MFD System for The F-22A Raptor (Right)
#
...
var ae = canvas.new({
  "name": "Right-MFD",   # The name is optional but allow for easier identification
...
placements.mfd.addPlacement({"node": "rightmfd"});
